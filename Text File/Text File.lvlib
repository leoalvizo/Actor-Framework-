...
<Library LVVersion="20008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Save Text Msg.lvclass" Type="LVClass" URL="../Text File Messages/Save Text Msg/Save Text Msg.lvclass"/>
		<Item Name="Write Path Msg.lvclass" Type="LVClass" URL="../Text File Messages/Write Path Msg/Write Path Msg.lvclass"/>
	</Item>
	<Item Name="Text File.lvclass" Type="LVClass" URL="../Text File/Text File.lvclass"/>
</Library>
